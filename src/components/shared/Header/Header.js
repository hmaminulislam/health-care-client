  ...
  return (
    <header className="p-4 dark:bg-gray-800 dark:text-gray-100">
      <div className="container flex justify-between h-16 mx-auto">
        <Link
          to="/"
          className="flex items-center p-2 text-3xl font-bold text-emerald-600"
        >
          Health Care
        </Link>
        ...
        </button>
        {
          <div
            className={`flex flex-col h-auto px-3 py-8 w-full bg-gray-900 text-gray-100 absolute ${
              isOpen ? "left-0 top-24 ease-out" : "hidden"
            }`}
          >
            <div onClick={() => setIsOpen(!isOpen)} className="space-y-3">
