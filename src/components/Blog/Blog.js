        ...
        <div className="space-y-4 mt-10">
          ...
          <details className="w-full border rounded-lg">
            ...
            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-600">
              ...
              app’s frontend) and a server (your app’s backend). JWT differ from
          ...
          <details className="w-full border rounded-lg">
            ...
            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-600">
              ...
              help of NodeJS. It is mostly used on the server-side. Nodejs does
              not have capability to add HTML tags. V8 is the Javascript engine
              inside of node.js that parses and runs Javascript. Nodejs is used
