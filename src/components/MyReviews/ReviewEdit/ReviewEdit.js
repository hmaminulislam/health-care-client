...
const ReviewEdit = () => {
    ...
    const submitHandle = event => {
        ...
        //review update api
        fetch(`http://localhost:5000/edit-review/${CurrntReview._id}`, {
            method: 'PATCH',
            headers: {
    ...
    return (
      <section className="p-6 text-gray-800">
        <form onSubmit={submitHandle} className="container w-full max-w-xl p-8 mx-auto space-y-6 rounded-md shadow bg-gray-50">
